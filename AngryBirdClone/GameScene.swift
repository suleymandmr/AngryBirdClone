   ...
   //var bird2 = SKSpriteNode()
    ...
    override func didMove(to view: SKView) {
       ...
       */
        ...
        let birtTexture = SKTexture(imageNamed: "bird")
        
        bird.physicsBody = SKPhysicsBody(circleOfRadius: birtTexture.size().height / 14)
    ...
    override func update(_ currentTime: TimeInterval) {
        ...
        if let birdPhysicsBody = bird.physicsBody{
            if birdPhysicsBody.velocity.dx <= 0 && birdPhysicsBody.velocity.dy <= 0.1 && birdPhysicsBody.angularVelocity <= 0.1 && gameStarted == true {
